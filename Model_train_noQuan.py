...
encoder.load_weights('Modelsave/20220213-172613S35.772/encoder.h5')  # 预加载编码器权重
...
decoder.load_weights('Modelsave/20220213-172613S35.772/decoder.h5')  # 预加载解码器权重
...
# adam_opt = tfa.optimizers.AdamW(learning_rate=0.0005,weight_decay = 0.0001)  # 初始学习率为0.001
...
# 训练模型
autoencoder.fit(x=x_train, y=x_train, batch_size=100, epochs=20, validation_split=0.1,callbacks=[tensorboard_callback])
...
# save code
shutil.copyfile('./Model_define_tf_noQuan.py', modelpath+'Model_define_tf_noQuan.py')
